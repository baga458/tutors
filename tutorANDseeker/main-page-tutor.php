...
<body>
<header class="header_container student">
    <a class="support_link" href="request_page.php?id=<?=$_SESSION['user']['id']?>">Заявки на обучение</a>
    <a class="support_link" href="post-add.php?id=<?=$_SESSION['user']['id']?>">Добавить услугу</a>
...
<main>
    <form action="main-page-tutor.php" class="form_container" method="post" style="width: 750px; margin: 30px auto 0 auto">
...
<!--                <option value="Беларусь">Беларусь</option>-->
            ...
            <select class="filters" name="teaching" >
                <option value="">Программа обучения...</option>
    ...
    <h1 class="form_title all_post">Все вакансии:</h1>
